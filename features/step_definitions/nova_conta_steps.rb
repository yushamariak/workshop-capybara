...
#Cadastro
Quando('preencher os {string}') do |campos|
    @sign_in = SignInPage.new
    
    @sign_in.criar_conta 'ys1@tst.com'
    @sign_in.register('Mrs.', 'Yusha', 'Silva', '123456', '23', 'February', '1990', 'TestCo', '721 Broadway, New York, NY 10003, USA', 'New York', 'Alabama', '10003', '11998787877') 
